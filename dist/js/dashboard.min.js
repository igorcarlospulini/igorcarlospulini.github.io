...
function OperadorCtrl(a,e){a.dados=function(){return e.getItem()},a.$watch(a.dados,function(o,n){a.dados=e.getItem(),a.changedValue=function(e){desenharTimelineOperador(e,a.dados)}})}function desenharTimelineOperador(a,e){function o(){var o=document.getElementById("timeline-chart-operador"),n=new google.visualization.Timeline(o),r=new google.visualization.DataTable;r.addColumn({type:"string",id:"Máquina"}),r.addColumn({type:"string",id:"Job"}),r.addColumn({type:"string",role:"Tarefa"}),r.addColumn({type:"date",id:"Início"}),r.addColumn({type:"date",id:"Fim"}),angular.forEach(e.distribuicao,function(e,o){e.Linha==a&&r.addRow([e.Operador+" : "+e.Recurso,"Job "+e.Job,"Tarefa "+e.Tarefa,new Date(0,0,0,0,e.Inicio,0),new Date(0,0,0,0,e.Fim,0)])});var t=uniqueArrayValue(e.distribuicao,"Linha",a,"Recurso"),i={height:53.5*(t.length-1),timeline:{showBarLabels:!1,rowLabelStyle:{fontName:"Lato",fontSize:12,color:"black"}},hAxis:{format:"H:mm",color:"#FFFFFF"}};n.draw(r,i)}google.charts.load("current",{packages:["timeline"],callback:o}),google.charts.setOnLoadCallback(o)}angular.module("RDash").controller("OperadorCtrl",["$scope","DataService",OperadorCtrl]);
