...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(t,e){e.otherwise("/"),t.state("index",{url:"/",templateUrl:"templates/arquivo.html"}).state("evolucao",{url:"/evolucao",templateUrl:"templates/evolucao.html"}).state("maquinas",{url:"/maquinas",templateUrl:"templates/maquinas.html"}).state("resumo",{url:"/resumo",templateUrl:"templates/resumo.html"}).state("completo",{url:"/completo",templateUrl:"templates/completo.html"}).state("linhas",{url:"/linhas",templateUrl:"templates/linhas.html"})}]);
...
function EvolucaoCtrl(a,o){a.dados=function(){return o.getItem()},a.$watch(a.dados,function(e,t){a.dados=o.getItem(),angular.forEach(a.dados.evolucao,function(a,o){desenharEvolucao(a,a.Geracao)})})}function desenharEvolucao(a,o){function e(){var e=new google.visualization.DataTable;e.addColumn("number","Intervalo"),e.addColumn("number","Valor");var t=0;angular.forEach(a,function(a,o){e.addRow([t++,parseFloat(a)])});var n={hAxis:{title:"Geração"},vAxis:{title:o}},l=new google.visualization.LineChart(document.getElementById("chart-"+o));l.draw(e,n)}google.charts.load("current",{packages:["corechart","line"]}),google.charts.setOnLoadCallback(e)}angular.module("RDash").controller("EvolucaoCtrl",["$scope","DataService",EvolucaoCtrl]);
...
function MasterCtrl(e,o,t){e.upload=function(){t.setItem(e.excel)};var a=992;e.getWidth=function(){return window.innerWidth},e.$watch(e.getWidth,function(t,n){t>=a?angular.isDefined(o.get("toggle"))?e.toggle=!!o.get("toggle"):e.toggle=!0:e.toggle=!1}),e.toggleSidebar=function(){e.toggle=!e.toggle,o.put("toggle",e.toggle)},window.onresize=function(){e.$apply()},e.menu_list=[{name:"Arquivo",icon:"fa-upload",href:""},{name:"Resumo",icon:"fa-bookmark",href:"#/resumo"},{name:"Completo",icon:"fa-bookmark-o",href:"#/completo"},{name:"Linhas",icon:"fa-clock-o",href:"#/linhas"},{name:"Máquinas",icon:"fa-area-chart",href:"#/maquinas"},{name:"Evolução",icon:"fa-line-chart",href:"#/evolucao"}]}angular.module("RDash").controller("MasterCtrl",["$scope","$cookieStore","DataService",MasterCtrl]);
