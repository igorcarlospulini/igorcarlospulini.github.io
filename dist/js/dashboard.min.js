...
function OperadorCtrl(e,a){e.dados=function(){return a.getItem()},e.$watch(e.dados,function(n,o){e.dados=a.getItem()}),e.changedValue=function(a){desenharTimelineLinha(a,e.dados),desenharTimelineOperador(a,e.dados)},e.baixarTimeline=function(){html2canvas(document.getElementById("timeline-chart-linha"),{onrendered:function(e){var a=e.toDataURL("image/png");downloadURI("data:"+a,"yourImage.png")}})},e.baixarOperador=function(){html2canvas(document.getElementById("timeline-chart-operador"),{onrendered:function(e){var a=e.toDataURL("image/png");downloadURI("data:"+a,"yourImage.png")}})}}function downloadURI(e,a){var n=document.createElement("a");n.download=a,n.href=e,document.body.appendChild(n),n.click()}function convertImageToCanvas(e){var a=document.createElement("canvas");return a.width=e.width,a.height=e.height,a.getContext("2d").drawImage(e,0,0),a}function desenharTimelineOperador(e,a){function n(){var n=new google.visualization.DataTable;n.addColumn({type:"string",id:"Máquina"}),n.addColumn({type:"string",id:"Job"}),n.addColumn({type:"string",role:"Tarefa"}),n.addColumn({type:"date",id:"Início"}),n.addColumn({type:"date",id:"Fim"}),angular.forEach(a.distribuicao,function(a,o){a.Linha==e&&n.addRow([a.Operador,"Job "+a.Job,"Tarefa "+a.Tarefa,new Date(0,0,0,0,a.Inicio,0),new Date(0,0,0,0,a.Fim,0)])});var o=uniqueArrayValue(a.distribuicao,"Linha",e,"Recurso"),t={height:53.5*(o.length-1),timeline:{showBarLabels:!1,rowLabelStyle:{fontName:"Lato",fontSize:12,color:"black"}},hAxis:{format:"H:mm",color:"#FFFFFF"}},i=document.getElementById("timeline-chart-operador"),r=new google.visualization.Timeline(i);r.draw(n,t)}google.charts.load("current",{packages:["timeline"]}),google.charts.setOnLoadCallback(n)}function desenharTimelineLinha(e,a){function n(){var n=new google.visualization.DataTable;n.addColumn({type:"string",id:"Máquina"}),n.addColumn({type:"string",id:"Job"}),n.addColumn({type:"string",role:"Tarefa"}),n.addColumn({type:"date",id:"Início"}),n.addColumn({type:"date",id:"Fim"}),angular.forEach(a.distribuicao,function(a,o){a.Linha==e&&n.addRow([a.Operador+" : "+a.Recurso,"Job "+a.Job,"Tarefa "+a.Tarefa,new Date(0,0,0,0,a.Inicio,0),new Date(0,0,0,0,a.Fim,0)])});var o=uniqueArrayValue(a.distribuicao,"Linha",e,"Recurso"),t={height:53.5*(o.length-1),timeline:{showBarLabels:!1,rowLabelStyle:{fontName:"Lato",fontSize:12,color:"black"}},hAxis:{format:"H:mm",color:"#FFFFFF"}},i=document.getElementById("timeline-chart-linha"),r=new google.visualization.Timeline(i);r.draw(n,t)}google.charts.load("current",{packages:["timeline"]}),google.charts.setOnLoadCallback(n)}angular.module("RDash").controller("OperadorCtrl",["$scope","DataService",OperadorCtrl]);
