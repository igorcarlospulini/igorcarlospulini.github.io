...
function LinhaCtrl(a,o){a.dados=function(){return o.getItem()},a.$watch(a.dados,function(n,t){a.dados=o.getItem(),0==angular.equals({},a.dados)&&desenharLinhas(a.dados)})}function desenharLinhas(a){function o(){var o=[["Utilização","Total","Ocupado","Ocioso"]],n=uniqueArray(a.distribuicao,"Linha");angular.forEach(n,function(n,t){var e=useMaquina(n.Linha,a),r=0,i=0;angular.forEach(e,function(a,o){r+=a.trabalho,i+=a.ocioso}),o.push([n.Linha,parseFloat(r)+parseFloat(i),r,i])});var t=google.visualization.arrayToDataTable(o),e={title:"Gráfico: Linhas de Produção",height:80*n.length,fontName:"Lato",fontSize:12,legend:{position:"top",maxLines:3},legendTextStyle:{fontName:"Lato",fontSize:10},tooltipTextStyle:{fontName:"Lato",fontSize:14},chartArea:{height:"95%",width:"80%"}},r=new google.visualization.BarChart(document.getElementById("chart"));r.draw(t,e)}google.charts.load("current",{packages:["corechart","bar"]}),google.charts.setOnLoadCallback(o)}function uniqueArray(a,o){var n=[],t=[];return angular.forEach(a,function(a){var e=a[o];t.indexOf(e)===-1&&(t.push(e),n.push(a))}),n}function uniqueArrayValue(a,o,n,t){var e=[],r=[];return angular.forEach(a,function(a){if(a[o]==n)var i=a[t];r.indexOf(i)===-1&&(r.push(i),e.push(a))}),e}angular.module("RDash").controller("LinhaCtrl",["$scope","DataService",LinhaCtrl]);
function MaquinaCtrl(a,o){a.dados=function(){return o.getItem()},a.$watch(a.dados,function(t,e){a.dados=o.getItem(),0==angular.equals({},a.dados)&&desenharMaquinas(a.dados)})}function desenharMaquinas(a){function o(){var o=[["Utilização","Ocupado","Ocioso"]],t=0;angular.forEach(a.recursos,function(e,n){var r=e.Recurso,i="",s=0,l=0,c=0;angular.forEach(a.distribuicao,function(a,o){a.Recurso==r&&(i==a.Linha&&c!=parseFloat(a.Inicio)&&(l+=(parseFloat(a.Inicio)-c)*a.QtdeRecurso),s+=(parseFloat(a.Fim)-parseFloat(a.Inicio))*parseFloat(a.QtdeRecurso),c=parseFloat(a.Fim),i=a.Linha)}),(s>0||l>0)&&(o.push([r,s,l]),t++)});var e=google.visualization.arrayToDataTable(o),n={title:"Gráfico: Resursos/Máquinas",height:80*t,fontName:"Lato",fontSize:14,legend:{position:"top",maxLines:3},legendTextStyle:{fontName:"Lato",fontSize:12},tooltipTextStyle:{fontName:"Lato",fontSize:14}},r=new google.visualization.BarChart(document.getElementById("chart"));r.draw(e,n)}google.charts.load("current",{packages:["corechart","bar"]}),google.charts.setOnLoadCallback(o)}angular.module("RDash").controller("MaquinaCtrl",["$scope","DataService",MaquinaCtrl]);
function MasterCtrl(e,o,a){e.upload=function(){a.setItem(e.excel)};var n=992;e.getWidth=function(){return window.innerWidth},e.$watch(e.getWidth,function(a,t){a>=n?angular.isDefined(o.get("toggle"))?e.toggle=!!o.get("toggle"):e.toggle=!0:e.toggle=!1}),e.toggleSidebar=function(){e.toggle=!e.toggle,o.put("toggle",e.toggle)},window.onresize=function(){e.$apply()},e.menu_list=[{name:"Arquivo",icon:"fa-upload",href:""},{name:"Operador",icon:"fa-bookmark",href:"#/operador"},{name:"Resumo",icon:"fa-bookmark",href:"#/resumo"},{name:"Completo",icon:"fa-bookmark-o",href:"#/completo"},{name:"Linhas",icon:"fa-clock-o",href:"#/linhas"},{name:"Máquinas",icon:"fa-area-chart",href:"#/maquinas"},{name:"Evolução",icon:"fa-line-chart",href:"#/evolucao"}]}angular.module("RDash").controller("MasterCtrl",["$scope","$cookieStore","DataService",MasterCtrl]);
function OperadorCtrl(e,a){e.dados=function(){return a.getItem()},e.$watch(e.dados,function(o,n){e.dados=a.getItem(),e.changedValue=function(a){desenharTimelineLinha(a,e.dados);var o=angular.element(document.querySelector("#timeline-chart-operador"));o.empty(),e.selectOperador=0},e.changedValueOperador=function(a,o){desenharTimelineOperador(o,a,e.dados)}})}function desenharTimelineOperador(e,a,o){function n(){var n=document.getElementById("timeline-chart-operador"),i=new google.visualization.Timeline(n),t=new google.visualization.DataTable;t.addColumn({type:"string",id:"Máquina"}),t.addColumn({type:"string",id:"Job"}),t.addColumn({type:"string",role:"Tarefa"}),t.addColumn({type:"date",id:"Início"}),t.addColumn({type:"date",id:"Fim"}),angular.forEach(o.distribuicao,function(o,n){o.Linha==e&&o.Operador==a&&t.addRow([o.Operador,"Job "+o.Job,"Tarefa "+o.Tarefa,new Date(0,0,0,0,o.Inicio,0),new Date(0,0,0,0,o.Fim,0)])});var r=uniqueArrayValue(o.distribuicao,"Linha",e,"Recurso"),l={height:53.5*(r.length-1),timeline:{showBarLabels:!1,rowLabelStyle:{fontName:"Lato",fontSize:12,color:"black"}},hAxis:{format:"H:mm",color:"#FFFFFF"}};i.draw(t,l)}google.charts.load("current",{packages:["timeline"],callback:n}),google.charts.setOnLoadCallback(n)}function desenharTimelineLinha(e,a){function o(){var o=document.getElementById("timeline-chart-linha"),n=new google.visualization.Timeline(o),i=new google.visualization.DataTable;i.addColumn({type:"string",id:"Máquina"}),i.addColumn({type:"string",id:"Job"}),i.addColumn({type:"string",role:"Tarefa"}),i.addColumn({type:"date",id:"Início"}),i.addColumn({type:"date",id:"Fim"}),angular.forEach(a.distribuicao,function(a,o){a.Linha==e&&i.addRow([a.Operador+" : "+a.Recurso,"Job "+a.Job,"Tarefa "+a.Tarefa,new Date(0,0,0,0,a.Inicio,0),new Date(0,0,0,0,a.Fim,0)])});var t=uniqueArrayValue(a.distribuicao,"Linha",e,"Recurso"),r={height:53.5*(t.length-1),timeline:{showBarLabels:!1,rowLabelStyle:{fontName:"Lato",fontSize:12,color:"black"}},hAxis:{format:"H:mm",color:"#FFFFFF"}};n.draw(i,r)}google.charts.load("current",{packages:["timeline"],callback:o}),google.charts.setOnLoadCallback(o)}angular.module("RDash").controller("OperadorCtrl",["$scope","DataService",OperadorCtrl]);
